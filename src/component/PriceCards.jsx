...
const PriceCards = () => {
  return (
    <>
      <div className="flex justify-center space-x-10 max-md:flex-col max-md:space-x-0 max-md:items-center">
        {pricingInfo.map((items) => {
          return (
            <div
              key={items.plan} // Added a unique key
              className="shadow-lg w-[20vw] max-md:w-1/2 px-5 py-5 min-h-[60vh] transition-all hover:shadow-xl rounded-xl max-md:mb-5"
            >
